    ...
    <main>
        ...
        <div class="featured-plants">
            ...
            <ul class="plants">
                ...
                ?>
                <li class="plant">
                    <img src=<?php echo $plant->img?> alt="" width="217" height="217">
                    <p class="featured-plant-name"><?php echo $plant->name?></p>
                    <p class="featured-plant-price"><?php echo $plant->price?></p>
                </li>
                <?php }?>
            </ul>
        </div>
